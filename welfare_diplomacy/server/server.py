...
""" Concrete standalone server object. Manages and save server data and games on disk,
    ...
    .. code-block:: python
        ...
        >>> from welfare_diplomacy import Server
...
import welfare_diplomacy.settings
from welfare_diplomacy.communication import notifications
from welfare_diplomacy.daide.server import Server as DaideServer
from welfare_diplomacy.server.connection_handler import ConnectionHandler
from welfare_diplomacy.server.notifier import Notifier
from welfare_diplomacy.server.scheduler import Scheduler
from welfare_diplomacy.server.server_game import ServerGame
from welfare_diplomacy.server.users import Users
from welfare_diplomacy.engine.map import Map
from welfare_diplomacy.utils import common, exceptions, strings, constants
